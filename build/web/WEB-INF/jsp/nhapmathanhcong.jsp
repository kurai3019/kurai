...
<div id="id02" class="modal">
  ...
  <form name="counter" class="modal-content" action="student99/quayve.html">
    <div class="container">
      ...
      <hr>
                  	${message2}
                        <hr>
      <label for="email"><b>Mail của bạn</b></label><br>

            <input type="text" value="${uid}" name="id" readonly="" required>
		...
		<script src="/assets/js/flipclock/flipclock.min.js"></script>
         ...
         <label for="email"><b>Thời gian link hết hạn</b></label><br>
         <input type="text" size="8"
        name="d2" id="my1" readonly="true">
      <p>Mọi chi tiết liên hệ Đạt Kurai <a href="#" style="color:dodgerblue">Tôi chưa nhận được link đổi mật khẩu</a>.</p>
        ...
        <div class="container">
            <div class="login-content form-signin">
                ...
                <label class="checkbox">
                        ...
                        <button id="Sign" type="submit"class="btn btn-large btn-primary btn btn-success btn-flat m-b-30 m-t-30c" href="index.html"  >ĐĂNG NHẬP</button>
