...
<head>
  ...
  .modal-content{      margin-top: 600px;margin-left: 100px;
}
  .modal-footer {
  ...
  <div class="modal fade" id="myModal" role="dialog" >
      ...
      <div class="modal-content row" id="main" style="  margin-left: -40px;                     width: 900px;" >
        ...
        <div class="modal-body" style="padding:40px 50px ;">
                                    <c:forEach var="rows" items="${lichsudiem}">
                                        <b style="color:red">${rows.type} điểm</b>    cho ${rows.name} vì đã được đánh giá: ${rows.reason}, được ghi nhận vào ${rows.date}
                                        <br> <br>                      
                                    </c:forEach>    
            ...
            <div class="animated fadeIn">
                ...
                <div class="col-md-12">
                    ...
                    <table id="bootstrap-data-table" class="table table-striped table-bordered">
                      ...
                      <button type="button" style="font-size: 20px; margin-left: 1100px" class="btn btn-default btn-lg" onclick="document.getElementById('my1').value = ''; document.getElementById('my2').value = ''" id="myBtn">  </span>  Lịch sử điểm</button>
                      <hr>
                        <thead>
                    ...
                    <tbody>
                                <c:forEach var="rows" items="${xephangnv}">
     
                      <tr>
                          <td width="130px" height="168px" style="text-align: center">	<img src="${rows.photo}"  width="150px" height="168px"> </td>
                <td style="text-align: center; padding-top: 70px; font-size: 20px">${rows.name}</td>
            <td style="text-align: center ;padding-top: 70px; font-size: 20px; font-weight: bold;color:red">${rows.mark}</td>
                <td style="text-align: center; padding-top: 70px; font-size: 20px">${rows.departs}</td>    
