...
<div id="id02" class="modal">
  ...
  <form class="modal-content" action="student99/sosanhkey.html">
    <div class="container">
      <h1>Thành công !!!</h1>
      <p>Nhập mật khẩu mới của bạn</p>
      <hr>
      <label for="email"><b>Mail</b></label>
      <input name="txtkey" type="text" value="${uid}" name="id" readonly="true"  required>
      
      <input name="txtkey1" type="password" placeholder="Nhập mật khẩu" name="mk" required>
      <input name="txtkey2" type="password" placeholder="Nhập lại mật khẩu" name="nhaplaimk" required>
